...
use App\Http\Requests\Admin\Masters\Designation\StoreDesignationRequest;
use App\Http\Requests\Admin\Masters\Designation\UpdateDesignationRequest;
...
class DesignationController extends Controller
{
    ...
    {
        $designationsList = Designation::latest()->get();

        return view('admin.masters.designation')->with(['designationsList'=> $designationsList]);
    }
