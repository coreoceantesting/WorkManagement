                    ...
                    <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    <label class="col-form-label" for="name">Work Name<span class="text-danger">*</span></label>
                                    ...
                                    @foreach ($workList as $list)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn text-danger rem-element px-2 py-1" title="Delete Work" data-id="{{ $list->id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
