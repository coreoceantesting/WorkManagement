<x-admin.layout>
    ...
    <x-slot name="heading">Units</x-slot>
                ...
                <div class="card">
                    <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    <label class="col-form-label" for="name">Unit Name<span class="text-danger">*</span></label>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    ...
                    $("#editForm select[name='status']").val(data.unit.status);
                    $("#editForm input[name='name']").val(data.unit.name);
                    $("#editForm input[name='initial']").val(data.unit.initial);
                }
                else
                {
                    alert(data.error);
